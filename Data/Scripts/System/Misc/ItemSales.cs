...
namespace Server
{
	...
	public class ItemSalesInfo
	{
		...
		public static ItemSalesInfo[] m_SellingInfo = new ItemSalesInfo[]
		{
			...
			new ItemSalesInfo( typeof(	IronSafe	),	5000	,	5	,	0	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Banker	),
			...
			new ItemSalesInfo( typeof(	MetalSafe	),	5000	,	5	,	50	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Banker	),
			...
			new ItemSalesInfo( typeof(	Safe	),	60000	,	1	,	95	,	false	,	false	,	World.None	,	Category.None	,	Material.None	,	Market.Banker	),
